...
urlpatterns = [
    ...
    path('user_profile/prepare_razorpay_payment/', views.prepare_razorpay_payment, name='prepare_razorpay_payment'),
    path('user_profile/verify_razorpay_payment/', views.verify_razorpay_payment, name='verify_razorpay_payment'),
    path('user_profile/prepare_razorpay_payment_for_order/<str:order_id>/', views.prepare_razorpay_payment_for_order, name='prepare_razorpay_payment_for_order'),
    path('user_profile/verify_razorpay_payment_for_order/', views.verify_razorpay_payment_for_order, name='verify_razorpay_payment_for_order'),
